...
export type SpritePackerTypes = "Basic" | "Shelf" | "Guillotine" | "JoeRects" | "Skyline";
...
export const joeRectsPackerHeuristics = ["BestShortSide", "BestLongSide", "BestArea", "BottomLeftRule", "ContactPointRule"] as const;
...
export type AllHeuristics = BasicPackerHeuristics | ShelfPackerHeuristics | SkylinePackerHeuristics | JoeRectsPackerHeuristics | GuillotinePackerHeuristics;
